...
describe('Address Book', () => {
    ...
    it('open and close create dialog', () => {
        cy.get('[data-component="create-contact"]').contains('Create contact').click();
        cy.get('[data-component="create-dialog"]').should('not.have.css', 'visibility', 'hidden');
        cy.get('[data-component="close-create"]').click();
        cy.get('[data-component="create-dialog"]').should('have.css', 'visibility', 'hidden');
        cy.get('[data-component="create-contact"]').contains('Create contact').click();
        cy.get('[data-component="create-dialog"]').should('not.have.css', 'visibility', 'hidden');
